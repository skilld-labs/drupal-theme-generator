---
to: <%= h.src() %>/<%= h.changeCase.lower(name) %>/images/svg/radio-filled.svg
---
<svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M11 16.25C13.8995 16.25 16.25 13.8995 16.25 11C16.25 8.1005 13.8995 5.75 11 5.75C8.1005 5.75 5.75 8.1005 5.75 11C5.75 13.8995 8.1005 16.25 11 16.25Z"/>
</svg>
